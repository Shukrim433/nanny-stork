  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center w-full h-screen bg-white overflow-hidden">
        ...
        <section
          className="flex flex-col items-center justify-center  py-6 text-black bg-white overflow-auto lg:w-1/2"
          ...
          {search.length === 0 ? (
            ...
            responses.map((item, index) => (
              ...
              >
                ...
                <TypeWriterText
                  text={item.response}
                  onTextCompleted={() => setShowMore(true)}
                />
              </div>
            ))
          )}
